 ...
 */
export function MentionChips({ m }: { m: Extract<ViewMsg, { kind: "files" }> }) {
  return (
      ...
      {m.files.map((f) => {
        ...
        return (
          <span
            ...
            className={`inline-flex max-w-full items-center gap-1.5 rounded-lg border px-2 py-1 font-mono text-xs ${
