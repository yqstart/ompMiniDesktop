...
| token | 浅色 | 深色 | 用途 |
|---|---|---|---|
| `bg` | `#FAFAF9` | `#0C0C0C` | 应用底 |
| `surface` | `#FFFFFF` | `#171717` | 卡片、左栏 |
| `fg` | `#1C1917` | `#E7E5E4` | 正文 |
| `muted` | `#57534E` | `#A8A29E` | 次要文字（浅色对比约 7:1，深色约 5.5:1） |
| `border` | `#E7E5E4` | `#292524` | 分隔线、卡边 |
| `accent` | `#4F46E5` | `#818CF8` | 仅发送按钮、运行态圆点、链接 |
